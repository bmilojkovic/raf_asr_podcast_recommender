...
def extract_mfcc(full_audio_path):
    ...
    #mfcc_features = mfcc(wave, nwin=int(sample_rate * 0.03), fs=sample_rate, nceps=12)[0] # Talkbox is broken
    mfcc_features = mfcc(wave, samplerate=sample_rate, winlen=0.03 ,numcep=12)
